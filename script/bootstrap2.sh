...
sudo apt update
sudo apt upgrade -y
sudo apt install -y gcc openssl zlib1g-dev git xclip gnome-tweaks build-essential curl terminator dconf-editor gimp inkscape kicad peek rhythmbox vlc zeal
